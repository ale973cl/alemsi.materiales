...
- **Último commit:** este commit — `feat: asignar servicios adicionales por usuario`.
...
- **Qué se hizo:** Admin Total puede autorizar o retirar servicios adicionales desde la ficha de permisos de cada usuario. Esta administración solo se carga y muestra para Admin Total; los demás perfiles no ven esta configuración.
