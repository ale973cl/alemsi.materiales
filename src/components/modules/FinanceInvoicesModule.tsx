...
type View="dashboard"|"clients"|"invoices"|"renditions"|"orders"|"reports";
const tabs:[View,string][]=[["dashboard","Resumen regional"],["clients","Clientes y contratos"],["invoices","Facturas y pagos"],["renditions","Rendiciones"],["orders","OC pendientes"],["reports","Informes"]];
