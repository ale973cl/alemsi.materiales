...
export default async function Page() {
  ...
  const [clients, installations, materials, openCampaigns, pendingSurveys, openPOs, partialReceipts, openDispatches, financePending, emailPending, campaigns, activeCampaigns, orders, dispatches, audit, materialCatalog, clientInstallations, users, userInstallationAccess] = await Promise.all([
    ...
    supabase.from("campaigns").select("id,label,status,created_at,campaign_installations(campaign_id,installation_id,status,justification,installations(id,name,region,city,commune,contracts(id,name,clients(id,legal_name))))").eq("status","Abierta").order("created_at",{ascending:false}),
